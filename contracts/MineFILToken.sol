...
contract MineFILToken is StandardToken {
  ...
  uint8 public constant decimals = 3;                                       // Set the number of decimals for display
  uint256 public constant INITIAL_SUPPLY = 1e8 * 10**uint256(decimals);     // 100 million billion MFIL
